...
input.setAttribute('autocomplete','off');inputDescrip.setAttribute('name','description');divDescription.appendChild(labelDescrip);divDescription.appendChild(inputDescrip);formNode.appendChild(divDescription);const button=document.createElement('button');button.className='button-login button-block';button.setAttribute('type','submit');button.innerHTML='Adicionar';const anchor=document.createElement('a');anchor.href='/main/projects';anchor.className='modal__close demo-close';anchor.innerHTML=`<svg viewBox="0 0 24 24">

...
(()=>{const update=setInterval(async()=>{await fetch('/operacao/addresultado',{method:'GET',headers:{'Content-Type':'application/json'},mode:'cors'}).then((response)=>{console.log('test',response.status)
...
(()=>{const validation=setInterval(async()=>{await fetch('/operacao/status',{method:'GET',headers:{'Content-Type':'application/json'}}).then((response)=>{return response.json();}).then((resp)=>{console.log('validacao',resp)

...
(()=>{const update=setInterval(async()=>{await fetch('/operacao/resultado',{method:'GET',headers:{'Content-Type':'application/json'},mode:'cors'}).then((response)=>{console.log('test',response.status)
